    ...
    <section id="logic" className="py-20 lg:py-40 bg-black overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col items-center text-center mb-16 lg:mb-32">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-7xl font-semibold brand-font tracking-tight max-w-3xl">Built to <span className="italic text-zinc-400">get things done.</span></h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          <div className="stat-card p-8 lg:p-12 rounded-3xl lg:rounded-[40px] flex flex-col h-full">
            ...
            <p className="text-sm lg:text-base text-zinc-500 leading-relaxed font-light">Boards are your team&apos;s shared workspace — plans, tasks, notes, and guides all in one place.</p>
          </div>
          ...
          <div className="stat-card p-8 lg:p-12 rounded-3xl lg:rounded-[40px] flex flex-col h-full">
            ...
            <h3 className="text-xl lg:text-2xl font-semibold mb-3 lg:mb-4">AI that knows your work</h3>
            <p className="text-sm lg:text-base text-zinc-500 leading-relaxed font-light">BORDS AI lives inside your boards. Ask it anything — it uses what your team has already built to give useful, specific answers.</p>
          </div>
        </div>
      </div>
    </section>
