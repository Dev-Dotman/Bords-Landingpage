    ...
    <section className="py-40 bg-black text-center">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center">
          <a href="https://app.bords.app" target="_blank" rel="noopener noreferrer" className="px-12 py-5 bg-white text-black rounded-2xl font-semibold text-lg hover:scale-105 transition-all shadow-xl inline-block text-center">Get Started</a>
