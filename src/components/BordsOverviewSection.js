      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="text-center mb-14 lg:mb-20">
          ...
          <h2 className="text-3xl md:text-5xl lg:text-7xl font-semibold tracking-tight mb-6 lg:mb-8">
            ...
            <span className="text-zinc-500">for collaborative work.</span>
          </h2>
          <p className="text-base lg:text-xl text-zinc-400 leading-relaxed font-light max-w-2xl mx-auto">
            One connected system for planning, execution, decisions, and team knowledge.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-10 lg:space-y-12">
            <div className="space-y-4">
              <p className="text-[10px] lg:text-xs uppercase tracking-[0.35em] text-zinc-500">01 / Replace Fragmentation</p>
              <p className="text-lg lg:text-2xl text-zinc-200 leading-relaxed font-light max-w-3xl">
                Instead of splitting work across docs, chats, task tools, and whiteboards,
                BORDS keeps everything inside boards that teams can actually operate from.
              </p>
            </div>

            <div className="space-y-4">
              <p className="text-[10px] lg:text-xs uppercase tracking-[0.35em] text-zinc-500">02 / Add Context-Aware Assistance</p>
              <p className="text-base lg:text-xl text-zinc-400 leading-relaxed font-light max-w-3xl">
                BORDS AI works inside those boards. It helps structure work, shape plans,
                draft SOPs, and answer questions using real workspace context.
              </p>
            </div>

            <div className="space-y-4">
              <p className="text-[10px] lg:text-xs uppercase tracking-[0.35em] text-zinc-500">03 / Build Organizational Memory</p>
              <p className="text-base lg:text-xl text-zinc-400 leading-relaxed font-light max-w-3xl">
                As teams keep executing, decisions and workflows compound into a living knowledge system,
                making work easier to retrieve, teach, and improve over time.
              </p>
            </div>
